...
class ProjectModelTest(ExtTestCase):
    ...
    def test_get_tasks_by_phase(self):
        ...
        blocked = Phase.objects.get(name='blocked')
        ...
        self.assertEqual(project.tasks_this_week.count(), 0)
        self.assertEqual(project.tasks_last_week.count(), 1)
        self.assertEqual(project.tasks.count(), 1)
        self.assertEqual(project.tasks_finished[0], task_1)
        self.assertEqual(project.tasks_last_week[0], task_1)
        ...
        self.assertEqual(project.tasks_this_week.count(), 1)
        self.assertEqual(project.tasks.count(), 2)
        self.assertEqual(project.tasks_ongoing[0], task_2)
        self.assertEqual(project.tasks_this_week[0], task_2)
        ...
        self.assertEqual(project.tasks_last_week.count(), 2)
        self.assertEqual(project.tasks_this_week.count(), 2)
        task_6 = Task.objects.create(project=project, name='task_6', work_left=1, created_by=creator, phase=blocked)
        self.assertEqual(project.tasks_done.count(), 1)
        self.assertEqual(project.tasks_finished.count(), 1)
        self.assertEqual(project.tasks_ongoing.count(), 1)
        self.assertEqual(project.tasks_continuing.count(), 1)
        self.assertEqual(project.tasks_pending.count(), 1)
        self.assertEqual(project.tasks_unfinished.count(), 4)
        self.assertEqual(project.tasks_not_done.count(), 5)
        self.assertEqual(project.tasks_last_week.count(), 2)
        self.assertEqual(project.tasks_this_week.count(), 2)
        self.assertEqual(project.tasks.count(), 6)
        ...
        self.assertEqual(project.tasks_by_phase_name('blocked').count(), 1)
...
class TaskModelTest(TestCase):
    ...
    def test_next_phase_url(self):
        creator = User.objects.create(username='creator')
        project = Project.objects.create(name='test_project', created_by=creator)
        pending = Phase.objects.create(name='pending', title='Pending')
        ongoing = Phase.objects.create(name='ongoing', title='Ongoing')
        finished = Phase.objects.create(name='finished', title='Finished')
        task_1 = Task.objects.create(project=project, name='task_1', phase=pending, created_by=creator)
        self.assertEqual(task_1.next_phase_url['url'],
                         reverse('tasks:task_set_phase_to', args=[project.name, task_1.name, 'ongoing']))
        self.assertEqual(task_1.next_phase_url['title'], 'Start')
        task_2 = Task.objects.create(project=project, name='task_2', phase=ongoing, created_by=creator)
